...
// Davide> Options
    ...
    , infiniteCnt(0)
    , tnode(0)
    , diversification_stop_nodes_ID(0)
    , n_pool_duplicatesID(0)
    , n_threads_blockedID(0)
    , n_import_shcl_unsatID(0)
    , sum_clauses_pools_lv1ID(0)
    , sum_clauses_pools_lv1_effID(0)
    , sum_clauses_pools_lv0ID(0)
    , sum_clauses_pools_lv0_effID(0)
    , n_unary_shclausesID(0)
    , n_binary_shclausesID(0)
    , n_lbd2_shclausesID(0)
    , n_clsent_curr_lvID(0)
    , n_clsent_prev_lvID(0)
    , n_clcanbeccminID(0)
    , n_ccmin_worseningID(0)
    , n_tot_sharedID(0)
    , n_tot_shared_minus_delID(0)
